    ...
    sections: [
      ...
      { id:'pricing-faq', label:'FAQ Section',
        fields: [
          ...
          { id:'faq2a', label:'FAQ 2 — Answer',   type:'textarea', default:'Yes! Our Free plan lets you list your school and receive 5 lead credits every month, forever. No credit card required.' },
          { id:'faq3q', label:'FAQ 3 — Question', type:'text',     default:'Do credits roll over?' },
          { id:'faq3a', label:'FAQ 3 — Answer',   type:'textarea', default:'Monthly plan credits do not roll over. However, bulk credit packs you purchase separately never expire.' },
