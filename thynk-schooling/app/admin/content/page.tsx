    ...
    sections: [
      { id:'pricing', label:'Pricing Page',
        fields: [
          ...
          { id:'pricingSub',   label:'Subtitle',         type:'textarea', default:'Subscribe to a plan and get lead credits included. Buy single leads anytime. No lock-in.' },
      ...
      { id:'pricing-faq', label:'FAQ Section',
        fields: [
          ...
          { id:'faq2a', label:'FAQ 2 - Answer',   type:'textarea', default:'Yes! Our Free subscription plan lets you list your school and get lead credits included, forever. No credit card required.' },
    ...
    sections: [
      { id:'school-packages-hero', label:'Page Hero',
        fields: [
          ...
          { id:'pkgSubtext',   label:'Subtitle',                    type:'textarea', default:'Get lead credits included with your plan. Buy single leads anytime.' },
        ],
      },
      { id:'school-packages-cta', label:'Checkout & CTA',
        fields: [
          ...
          { id:'pkgPayPerLead', label:'Pay-per-lead note',          type:'textarea', default:'Buy single leads directly from your Leads page — no subscription required.' },
        ],
      },
