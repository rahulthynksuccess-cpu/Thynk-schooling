...
const SEED_DATA: Array<{ category: string; label: string; value: string; sortOrder?: number }> = [
  ...
  // ── Facilities ──────────────────────────────────────────────────────
  { category: 'facility', label: 'Transport / School Bus',  value: 'transport',      sortOrder: 1 },
  { category: 'facility', label: 'Swimming Pool',           value: 'swimming_pool',  sortOrder: 2 },
  { category: 'facility', label: 'Sports Ground',           value: 'sports_ground',  sortOrder: 3 },
  { category: 'facility', label: 'Science Lab',             value: 'science_lab',    sortOrder: 4 },
  { category: 'facility', label: 'Computer Lab',            value: 'computer_lab',   sortOrder: 5 },
  { category: 'facility', label: 'Library',                 value: 'library',        sortOrder: 6 },
  { category: 'facility', label: 'Cafeteria / Canteen',     value: 'cafeteria',      sortOrder: 7 },
  { category: 'facility', label: 'Hostel / Boarding',       value: 'hostel',         sortOrder: 8 },
  { category: 'facility', label: 'Infirmary / Medical Room',value: 'infirmary',      sortOrder: 9 },
  { category: 'facility', label: 'Smart Classrooms',        value: 'smart_classrooms',sortOrder: 10 },
  { category: 'facility', label: 'Auditorium',              value: 'auditorium',     sortOrder: 11 },
  { category: 'facility', label: 'CCTV Surveillance',       value: 'cctv',           sortOrder: 12 },
  { category: 'facility', label: 'Wi-Fi Campus',            value: 'wifi',           sortOrder: 13 },
  { category: 'facility', label: 'Indoor Sports Hall',      value: 'indoor_sports',  sortOrder: 14 },

  // ── Sports ─────────────────────────────────────────────────────────
  { category: 'sport', label: 'Cricket',          value: 'cricket',     sortOrder: 1 },
  { category: 'sport', label: 'Football',         value: 'football',    sortOrder: 2 },
  { category: 'sport', label: 'Basketball',       value: 'basketball',  sortOrder: 3 },
  { category: 'sport', label: 'Volleyball',       value: 'volleyball',  sortOrder: 4 },
  { category: 'sport', label: 'Badminton',        value: 'badminton',   sortOrder: 5 },
  { category: 'sport', label: 'Table Tennis',     value: 'table_tennis',sortOrder: 6 },
  { category: 'sport', label: 'Athletics / Track',value: 'athletics',   sortOrder: 7 },
  { category: 'sport', label: 'Swimming',         value: 'swimming',    sortOrder: 8 },
  { category: 'sport', label: 'Kabaddi',          value: 'kabaddi',     sortOrder: 9 },
  { category: 'sport', label: 'Chess',            value: 'chess',       sortOrder: 10 },
  { category: 'sport', label: 'Yoga',             value: 'yoga',        sortOrder: 11 },
  { category: 'sport', label: 'Martial Arts',     value: 'martial_arts',sortOrder: 12 },
  { category: 'sport', label: 'Skating',          value: 'skating',     sortOrder: 13 },
  { category: 'sport', label: 'Gymnastics',       value: 'gymnastics',  sortOrder: 14 },

  // ── Languages ──────────────────────────────────────────────────────
  { category: 'language', label: 'Hindi',      value: 'hindi',      sortOrder: 1 },
  { category: 'language', label: 'English',    value: 'english',    sortOrder: 2 },
  { category: 'language', label: 'Sanskrit',   value: 'sanskrit',   sortOrder: 3 },
  { category: 'language', label: 'French',     value: 'french',     sortOrder: 4 },
  { category: 'language', label: 'German',     value: 'german',     sortOrder: 5 },
  { category: 'language', label: 'Spanish',    value: 'spanish',    sortOrder: 6 },
  { category: 'language', label: 'Marathi',    value: 'marathi',    sortOrder: 7 },
  { category: 'language', label: 'Kannada',    value: 'kannada',    sortOrder: 8 },
  { category: 'language', label: 'Tamil',      value: 'tamil',      sortOrder: 9 },
  { category: 'language', label: 'Telugu',     value: 'telugu',     sortOrder: 10 },
  { category: 'language', label: 'Bengali',    value: 'bengali',    sortOrder: 11 },
  { category: 'language', label: 'Gujarati',   value: 'gujarati',   sortOrder: 12 },
  { category: 'language', label: 'Punjabi',    value: 'punjabi',    sortOrder: 13 },

  // ── Extracurricular ────────────────────────────────────────────────
  { category: 'extracurricular', label: 'Music',              value: 'music',         sortOrder: 1 },
  { category: 'extracurricular', label: 'Dance',              value: 'dance',         sortOrder: 2 },
  { category: 'extracurricular', label: 'Drama / Theatre',    value: 'drama',         sortOrder: 3 },
  { category: 'extracurricular', label: 'Art & Craft',        value: 'art_craft',     sortOrder: 4 },
  { category: 'extracurricular', label: 'Robotics & Coding',  value: 'robotics',      sortOrder: 5 },
  { category: 'extracurricular', label: 'Debate Club',        value: 'debate',        sortOrder: 6 },
  { category: 'extracurricular', label: 'Quiz Club',          value: 'quiz',          sortOrder: 7 },
  { category: 'extracurricular', label: 'Model UN (MUN)',     value: 'mun',           sortOrder: 8 },
  { category: 'extracurricular', label: 'Photography',        value: 'photography',   sortOrder: 9 },
  { category: 'extracurricular', label: 'Environment Club',   value: 'eco_club',      sortOrder: 10 },
  { category: 'extracurricular', label: 'NCC',                value: 'ncc',           sortOrder: 11 },
  { category: 'extracurricular', label: 'NSS',                value: 'nss',           sortOrder: 12 },
  { category: 'extracurricular', label: 'Scouts & Guides',    value: 'scouts',        sortOrder: 13 },
  { category: 'extracurricular', label: 'Entrepreneurship',   value: 'entrepreneurship',sortOrder: 14 },
  // States
