...
const NAV_GROUPS = [
  ...
  { label:'Management', items:[
    ...
    { icon:BarChart3,     label:'↳ School Analytics', href:'/admin/schools/analytics' },
    ...
    { icon:BarChart3,     label:'↳ Lead Analytics',   href:'/admin/leads/analytics' },
  ...
  { label:'Monetisation', items:[
    ...
    { icon:BarChart3,   label:'↳ Payment Analytics',     href:'/admin/payments/analytics' },
  ]},
