...
export function Footer() {
  return (
    <>
      ...
      `}</style>
      <footer style={{ background:'#0D1117', color:'rgba(250,247,242,0.5)', fontFamily:'Inter,sans-serif' }}>
        <div style={{ maxWidth:'1160px', margin:'0 auto', padding:'0 48px' }}>

          {/* Main grid */}
          <div style={{ display:'grid', gridTemplateColumns:'2fr 1fr 1fr 1fr 1fr', gap:'40px', padding:'60px 0 48px' }}>
            ...
            {Object.entries(LINKS).map(([heading, links]) => (
              <div key={heading}>
                <h4 style={{ fontFamily:'Inter,sans-serif', fontSize:'10px', fontWeight:600, letterSpacing:'.14em', textTransform:'uppercase', color:'#B8860B', marginBottom:'16px' }}>
                  {heading}
                </h4>
