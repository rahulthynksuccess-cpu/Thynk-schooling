...
const STEPS = [
  {
    ...
    desc: 'Use AI-powered filters — city, board, fees, class, gender policy — to find schools matched to your child.',
  ...
  },
  {
    ...
    desc: 'Side-by-side comparison of fees, facilities, ratings, and admission criteria across multiple schools.',
  ...
  },
  {
    ...
    desc: 'Real-time status tracking on your parent dashboard. Get notified at every stage of admission.',
