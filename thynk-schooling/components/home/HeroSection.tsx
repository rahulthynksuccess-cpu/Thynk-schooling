        ...
        <div style={{ display:'grid', gridTemplateColumns:'minmax(0,1fr)', gap:'40px', alignItems:'center' }}>
          ...
          <div style={{ maxWidth:'680px' }}>
            ...
            <motion.h1 {...fade(0.18)} style={{
              ...
              {ct.h1Line1 || 'Find the'}
              <em style={{ display:'block', fontStyle:'italic', color:'var(--hero-italic-color,#B8860B)', fontSize:'1.04em' }}>{ct.h1Italic || 'Perfect School'}</em>
              <span style={{ display:'block', color:'rgba(13,17,23,0.2)', fontSize:'.62em', fontWeight:400, fontStyle:'normal', letterSpacing:'-1px' }}>{ct.h1Line3 || 'for Your Child'}</span>
            </motion.h1>
            ...
            <motion.p {...fade(0.26)} style={{
              ...
              {ct.subtext || <>Search, compare &amp; apply to{' '}<strong style={{ color:'var(--ink,#0D1117)', fontWeight:500 }}>12,000+ verified schools</strong>{' '}across 35+ Indian cities — CBSE, ICSE, IB &amp; Cambridge.</>}
            </motion.p>
